                ...
                <div className="pt-10 mx-auto">
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                <img src="/img/newlogo.png" className="rounded-full w-12" />
                                <p className="font-semibold text-xl text-white">GlobalShare</p>
                            </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/hnBB2SEzR5" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
                                <a href="https://discord.com/api/oauth2/authorize?client_id=1100500027840929963&permissions=259912895601&scope=applications.commands%20bot" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://discord.gg/hnBB2SEzR5">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; GlobalShare Advertisements
                        </p>
                        <div className="hidden md:flex items-center justify-center">
                                <p className={"text-xs text-green-400"}>
                                    GlobalShare is currently online and operational!
                                </p>
                        </div>
                        <p className="text-white text-center sm:text-right text-opacity-50">
                            {"Powered by NoobyJuli ❤️"}
                        </p>
                    </div>
                </div>
            </footer>
