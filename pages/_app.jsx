...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/invite/ZcDprCrFTn",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1100500027840929963&permissions=259912895601&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1100500027840929963/vote",
    },
    {
      link: true,
      name: "Partners",
